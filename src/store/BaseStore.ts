...
export abstract class BaseStore {
   ...
   */
  mapActions(){
    let res: Partial<{[K in keyof this]: this[K] extends Function ? this[K] : undefined}> = {}
    Object.getOwnPropertyNames((this as any)['__proto__']).forEach((key) => {
      if (typeof (this as any)[key] === 'function'){
        (res as any)[key] = (...args: any) => (this as any)[key](...args)
      }
    })
    return res as Omit<{[K in keyof this]: this[K] extends Function ? this[K] : undefined}, 'mapActions'>
  }
